...
export const NARRATORS = Object.freeze([
  {
    ...
    voxSeed: 104729,
    voxReferenceText: "Let’s take this one clear step at a time, and make the complex feel understandable.",
  },
  {
    id: "theo",
    name: "Theo",
    ...
    voxSeed: 130363,
    voxReferenceText: "The strongest explanation begins with the evidence, then follows each clue carefully.",
  },
  {
    id: "nova",
    name: "Nova",
    ...
    voxSeed: 155921,
    voxReferenceText: "Here is the surprising part, and it changes how the whole story comes together.",
  },
  {
    id: "ellis",
    name: "Ellis",
    ...
    voxSeed: 181081,
    voxReferenceText: "Across time, small details gather into a larger pattern worth noticing.",
  },
]);
