    ...
    <div className="content-wrap detail-page">
      ...
      <section className="detail-workspace">
        ...
        {tab === "publishing" && <div className="publishing-panel">
          <div className="publishing-intro"><div><h3>Upload everywhere at once</h3><p>Selected uploads start in parallel. Each platform reports progress and finishes independently.</p></div>{currentJob.reviewState === "approved" ? <span className="approval-complete"><Check size={13} /> Approved</span> : <ShieldCheck size={23} />}</div>
